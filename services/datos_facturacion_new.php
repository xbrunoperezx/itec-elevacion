...
$sql = "INSERT INTO datos_facturacion (id_cliente, fis_nombre, fis_direccion, fis_localidad, fis_cp, fis_provincia, cif, num_cuenta) VALUES ({$id_cliente}, '{$fis_nombre}', '{$fis_direccion}', '{$fis_localidad}', '{$fis_cp}', '{$fis_provincia}', '{$cif}', '{$num_cuenta}')";
